...
Nav.propTypes = {
  ...
  menuBtnOpen: PropTypes.shape({
    current: PropTypes.instanceOf(Element),
  }).isRequired,
  menuBtnClose: PropTypes.shape({
    current: PropTypes.instanceOf(Element),
  }).isRequired,
